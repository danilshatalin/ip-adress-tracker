...
function getData() {
    if ((0, _helpers.validateIp)(ipInput.value)) fetch(`https://geo.ipify.org/api/v2/country?apiKey=at_mlVfpQBmlWKPI38epqtXiaqX5jG6x&ipAddress=${ipInput.value}`).then((response)=>response.json()).then((data)=>setInfo(data));
}
...
},{"./helpers":"kEqbI"}],"kEqbI":[function(require,module,exports) {
...
},{}]},["igKGj","8lqZg"], "8lqZg", "parcelRequire1541")
